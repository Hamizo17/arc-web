...
<!-- ═══ EL ARMARIO QUE SE DESPIEZA AL BAJAR ═══
     ...
     enseña en veinte segundos lo que las seis tarjetas de abajo cuentan con
...
<section class="acto" id="armActo">
  <div class="escenario">
    ...
    <div class="arm-rot">
      <div class="num" id="armNum">01 / 05</div>
      <h2 class="cambia" id="armTit">El alzado</h2>
      <p class="cambia" id="armTxt">Un armario de 1800 × 600 × 2400. Es lo único que se dibuja: todo lo demás se deduce de aquí.</p>
    </div>

    <div class="arm-carril" id="armCarril"></div>

    <div class="arm-cuentas">
      <div><span>Piezas</span><b id="armPiezas">0</b></div>
      <div><span>Tablero</span><b id="armM2">0,00 m²</b></div>
      <div><span>Taladros</span><b id="armTal">0</b></div>
    </div>

    <div class="arm-pista" id="armPista">Sigue bajando</div>
  </div>
</section>
